    ...
    <div>
      ...
      >
        <div className='modalWrapper'>
          <img alt="" className='movie-image-modal' src={"https://image.tmdb.org/t/p/w500/" + props.movie.poster_path}></img>
      ...
      <div onClick={openModal} className="movie-container">
        <img alt="" className='movie-image' src={"https://image.tmdb.org/t/p/w500/" + props.movie.poster_path}></img>
        <div>
